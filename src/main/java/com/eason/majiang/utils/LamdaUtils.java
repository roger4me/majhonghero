...
public class LamdaUtils {
    @FunctionalInterface
    public interface Comsumer_WithException<T, E extends Exception> {
    ...
    public static <T, E extends Exception> Consumer<T> rethrowConsumer(Comsumer_WithException<T,E> consumer) throws E
    {
        return t -> {
            try {
                 consumer.accept(t);
